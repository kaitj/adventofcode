...
pub fn run_multi(days_to_run: &HashSet<Day>, is_release: bool, is_timed: bool) -> Option<Timings> {
    ...
    // Use non-duplicate, sorted day values
    all_days()
...
/// All solutions in isolated binaries
/// Module encapsulates interactions with binaries, invoking and parsing timing output.
