...
mod tests {
    ...
    mod merge {
        ...
        fn handles_disjunct_timings() {
            ...
            assert_eq!(merged_data.len(), 3);
            assert_eq!(merged_data[0].day, day!(1));
            assert_eq!(merged_data[1].day, day!(2));
            assert_eq!(merged_data[1].total_nanos, 0_f64);
            assert_eq!(merged_data[2].day, day!(3));
        }
